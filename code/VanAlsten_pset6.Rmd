...
and then:
\[\tau \le E[Y_{1i}|D_{i}=1]Pr(D_{i} = 1) + E[Y_{1i}|D_{i}=0]Pr(D_{i} = 0) -  E[Y_{0i}|D_{i}=1]Pr(D_{i} = 1) -  E[Y_{0i}|D_{i} = 0]Pr(D_{i} = 0)\]
...
\[
\begin{aligned}
        \tau \le \sum_{X\in x}(E[Y_{1i}|D_{i}=1, X_{i} = x]Pr(D_{i} = 1, X_{i} = x) +\\
         E[Y_{1i}|D_{i}=0, X_{i} = x]Pr(D_{i} = 0, X_{i} = x) -  \\
         E[Y_{0i}|D_{i}=1, X_{i} = x]Pr(D_{i} = 1, X_{i} = x) - \\
         E[Y_{0i}|D_{i} = 0, X_{i} = x]Pr(D_{i} = 0, X_{i} = x)) \\
\end{aligned}
\]
Given what we know about individuals with high incomes, we can also simplify further, such that:
This then becomes:
\[
\begin{aligned}
        \tau \le E[Y_{1i}|D_{i}=1]Pr(X_i =3) - \\
        E[Y_{0i}|D_{i} = 0]Pr(X_{i} = 3) +\\
